"""Combined script for neuron and supreme court modelling."""
...
DATA_PATH = Path("data")
NEURON_DATA_PATH = DATA_PATH / "neuron.txt"
...
def neuron_experiments():
    """Main function for neuron modelling experiment."""
    results = {}
